...
public class ReferenceCollectorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("一键导入子物体"))
        {
            referenceCollector.ImportChildObjects();
        }

        GUILayout.EndHorizontal();
        EditorGUILayout.BeginHorizontal();

        this.referenceCollector.SystemIndex = EditorGUILayout.Popup("Select System", 0, this.referenceCollector.SystemArr);
        // if (selectedIndex >= 0 && selectedIndex < systemArr.Length)
        // {
        //     Debug.Log("Selected System: " + systemArr[selectedIndex]);
        // }
