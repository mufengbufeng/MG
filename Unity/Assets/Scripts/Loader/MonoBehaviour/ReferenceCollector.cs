...
public class ReferenceCollector : MonoBehaviour, ISerializationCallbackReceiver
{
    ...
    public string[] SystemArr = new string[] { "UI", "Game", "..." };
    ...
    /// <summary>
    /// 一键导入子物体
    /// 获取最后一个单词: Obj，Btn,Text,Img,Toggle,Slider,Scroll,Input
    /// </summary>
    public void ImportChildObjects()
    {
        Transform[] children = gameObject.GetComponentsInChildren<Transform>(true);
        string[] suffixes = { "Go","Obj", "Btn", "Text", "Img", "Toggle", "Slider", "Scroll", "Input" };
        ...
        foreach (Transform child in children)
        {
            ...
            bool hasSuffix = suffixes.Any(suffix => childName.EndsWith(suffix));

            if (hasSuffix)
            {
                Add(childName, child.gameObject);
            }
        }
